                ...
                <Card>
                    ...
                    <Tabs>
                        <TabPane label="待查看" icon="information-circled">
                            <Table style="border-radius: 5px" border :columns="unFinshMessage.columns"
                                   :data="unFinshDate"></Table>
                        </TabPane>
                        <TabPane label="未解决" icon="close-round">
                            <Table style="border-radius: 5px" border :columns="waitFinshMessage.columns"
                                   :data="waitFinshDate"></Table>
                        </TabPane>
                        <TabPane label="已解决" icon="checkmark-round">
                            <Table style="border-radius: 5px" border :columns="hasFinshMessage.columns"
                                   :data="hasFinshDate"></Table>
                        </TabPane>
                    </Tabs>
                </Card>
            </Col>
